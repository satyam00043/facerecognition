        ...
        def draw_boundry(img,classifier,scaleFactor,minNeighbbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    ...
                    cv2.putText(img,f"name:{n}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),4)
                    cv2.putText(img,f"roll:{r}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),4)
                    cv2.putText(img,f"department:{d}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),4)
